...
export class BabyJubJubUtils {
	...
	public privateToPublicKey(privateKey: BigNumberish): PointObject {
		...
		return {
			x: this._uint8ArrayToBigInt(
				this.babyJub.F.fromMontgomery(this.babyJub.F.e(publicKeyPoint[0])).reverse()
			...
			y: this._uint8ArrayToBigInt(
				this.babyJub.F.fromMontgomery(this.babyJub.F.e(publicKeyPoint[1])).reverse()
			)
		};
	}
	...
	public exp_elgamal_decrypt_embedded(private_key: BigNumberish, C1: PointObject, C2: PointObject) {
		const shared_secret = this.babyJub.mulPointEscalar(
			[
		...
		return {
			x: this._uint8ArrayToBigInt(
				this.babyJub.F.fromMontgomery(this.babyJub.F.e(plain_embedded[0])).reverse()
			),
			y: this._uint8ArrayToBigInt(
				this.babyJub.F.fromMontgomery(this.babyJub.F.e(plain_embedded[1])).reverse()
			)
		};
	}
