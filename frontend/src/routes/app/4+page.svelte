<script>
	...
	import { showInfo, showSuccess, showWarning, showError } from '$lib/toastStore';
	...
	async function demo() {
		try {
			...
			showInfo('Loading circuit...');
			const { program } = await getCircuit();
			console.log('Circuit loaded successfully');
			showSuccess('Circuit loaded successfully');
			...
			showInfo('Initializing cryptographic primitives...');
			...
			showSuccess('Cryptographic primitives initialized');
			...
			showError('Error during circuit execution: ' + (error instanceof Error ? error.message : String(error)));
		}
	}
</script>
